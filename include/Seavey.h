#ifndef ANITA_SIM_SEAVEY_H
#define ANITA_SIM_SEAVEY_H

#include "TVector3.h"
#include "PropagatingSignal.h" // for PropagatingSignal
#include "FTPair.h"
#include "Constants.h"
...
namespace anitaSim {
  ...
  public:
    ...
    void addSignal(const icemc::PropagatingSignal& incomingSignal);
    ...
    const icemc::FTPair& get(Pol pol) const;
