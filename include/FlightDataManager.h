#ifndef ANITA_SIM_FLIGHT_DATA_MANAGER_H
#define ANITA_SIM_FLIGHT_DATA_MANAGER_H
...
namespace anitaSim {
  ...
  public:
    FlightDataManager(const Settings* settings);
    FlightDataManager(FlightPath path, const Settings* settings = nullptr);
  ...
  private:
    ...
    std::shared_ptr<TTreeInterpolator> fInterp;
