...
anitaSim::SimulatedSignal::SimulatedSignal()
 :RFSignal()
{
  // Default constructor
...
anitaSim::SimulatedSignal::SimulatedSignal(Int_t numPoints,Double_t *tVals,Double_t *vVals,Int_t mvNs)
...
void anitaSim::SimulatedSignal::updateSimSignalFromVmmhz(int nfreqs0, double *freqs0, double *freqAmp0)
{
  ...
  int firstNonZero = icemc::Tools::Getifreq(freqs0[0],0,newdf*nfreqs,nfreqs);
  int lastNonZero  = icemc::Tools::Getifreq(freqs0[nfreqs0-1],0,newdf*nfreqs,nfreqs);
...
void anitaSim::SimulatedSignal::addCW(double frequency, double phase, double amplitude){
...
void anitaSim::SimulatedSignal::getVmmhz(Anita *anita1, double *vmmhz){
  ...
  int firstNonZero = icemc::Tools::Getifreq(freqMin1,freqMin,freqMax,numFreqs);
  int lastNonZero  = icemc::Tools::Getifreq(freqMax1,freqMin,freqMax,numFreqs);
